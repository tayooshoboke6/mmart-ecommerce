          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 mt-1 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <div className="bg-white p-2 rounded shadow-sm flex items-center justify-center">
                  <span className="text-blue-800 font-medium">Mastercard</span>
                </div>
                <div className="bg-white p-2 rounded shadow-sm flex items-center justify-center">
                  <span className="text-green-700 font-medium">Verve</span>
                </div>
              </div>
            </div>
                ...
                <a href="#" className="block">
                  <div className="bg-black text-white px-4 py-2 rounded-lg flex items-center w-48">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M17.9 5c-.2 1.6-.6 2.8-1.5 4.1-.8 1.2-2.1 2.3-3.5 2.3-1.5 0-1.9-.9-3.5-.9-1.6 0-2.1.9-3.5.9-1.4 0-2.5-1-3.3-2.2C1.6 7.8.7 5.4 1.1 3c.3-1.8 1.6-3 3.1-3 1.4 0 2.2.8 3.4.8 1.1 0 1.8-.8 3.4-.8 1.3 0 2.5.7 3.1 2.1-2.7 1.6-2.3 5.5.8 6.9zM13 3.2c-.1-1.3.4-2.5 1-3.2.7 1.3.7 2.8 0 4.5-.7-.4-1-1-1-1.3z"/>
                    </svg>
                    <div>
