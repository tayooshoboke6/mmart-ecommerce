    ...
    <footer className="bg-gray-800 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company info */}
          <div>
            <h3 className="text-xl font-bold mb-4">M-Mart<span className="text-secondary">+</span></h3>
            <p className="text-gray-400 mb-4">
              Your one-stop shop for all your needs. We offer a wide range of products at competitive prices with fast delivery across Nigeria.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/orders" className="text-gray-400 hover:text-white">Order History</Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-400 hover:text-white">FAQ</Link>
              </li>
              <li>
                <Link to="/shipping" className="text-gray-400 hover:text-white">Shipping & Delivery</Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 pt-8 pb-4">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="bg-white p-2 rounded">
              <span className="text-gray-800 font-medium">Verve</span>
            </div>
            <div className="bg-white p-2 rounded">
              <span className="text-gray-800 font-medium">Paystack</span>
            </div>
            <div className="bg-white p-2 rounded">
              <span className="text-gray-800 font-medium">Flutterwave</span>
            </div>
            <div className="bg-white p-2 rounded">
        ...
        <div className="border-t border-gray-700 pt-8 mt-8 text-center">
          <p className="text-gray-400">
            &copy; {currentYear} M-Mart+. All rights reserved.
          </p>
